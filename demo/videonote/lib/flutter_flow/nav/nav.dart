...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      //errorBuilder: (context, _) => LibraryWidget(),
      routes: [
        /*FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => LibraryWidget(),
          routes: [
            FFRoute(
              name: 'Library',
              path: 'library',
            ...
            FFRoute(
              name: 'webNoteArea',
              path: 'webNoteArea',
              builder: (context, params) => WebNoteAreaWidget(),
            ),
            FFRoute(
              name: 'tabletNoteArea',
              path: 'tabletNoteArea',
              builder: (context, params) => TabletNoteAreaWidget(),
            )
